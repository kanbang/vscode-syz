var Tadpole = function() {
    ...
    this.terminal = 'vs'; //"web" "wx" "vs" "wap"
    this.weiboID = null;
    ...
    this.drawArrow = function(canvas, context, bounds) {
        tadpole.arrow.draw(canvas, context, bounds);
    };
    ...
    (function() {
        ...
        tadpole.arrow = new Arrow(tadpole);
    })();
}